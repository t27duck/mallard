...
module ApplicationHelper
  ...
  def prev_link
    ...
    link_to read_entries_path(page: page, search: params[:search]), class: "primary-color relative inline-flex items-center p-2 rounded-l-md border border-gray-300 bg-white text-sm font-medium text-gray-500 hover:bg-gray-50" do
      "&laquo;".html_safe
    end
  end
  ...
  def next_link
    ...
    link_to read_entries_path(page: page, search: params[:search]), class: "primary-color relative inline-flex items-center p-2 rounded-r-md border border-gray-300 bg-white text-sm font-medium text-gray-500 hover:bg-gray-50" do
      "&raquo;".html_safe
    end
  end
end
