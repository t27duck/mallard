...
CREATE TABLE IF NOT EXISTS "feeds" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "title" varchar NOT NULL, "url" varchar NOT NULL, "sanitize" boolean DEFAULT 1 NOT NULL, "last_checked" datetime, "created_at" datetime(6) NOT NULL, "updated_at" datetime(6) NOT NULL, "entry_count_in_fetch" integer DEFAULT 0 NOT NULL);
